...
import { getBalanceDisplayController } from '../model/BalanceDisplayController';
import { themeStore } from 'shared/model';

// ============================================================================
// Balance Display Controller Instance
// ============================================================================

const balanceDisplayController = getBalanceDisplayController(
    () => walletStore.currentTokenBalance !== undefined
);
...
export const BalanceDisplay = observer(function BalanceDisplay({
    ...
    const ctrl = balanceDisplayController;
