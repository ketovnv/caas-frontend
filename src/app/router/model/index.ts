...
class RouterStore {
  ...
  // Animation state - managed imperatively by UI
  ...
  // ─────────────────────────────────────────────────────────────
  // Animation (imperative - called by UI)
  // ─────────────────────────────────────────────────────────────

  /**
   * Called by UI when React Spring animation completes (onRest)
   */
  onTransitionEnd = () => {
    runInAction(() => {
  ...
  navigate(route: Route, params: RouteParams = {}, options: NavigateOptions = {}) {
    ...
    // No setTimeout - UI calls onTransitionEnd() when animation completes
  }
  ...
  private initFromUrl() {
    ...
    const route = this.parseRouteFromUrl();
